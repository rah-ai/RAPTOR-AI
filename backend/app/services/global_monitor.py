...
async def poll_global_airports():
    ...
    for airport in GLOBAL_AIRPORTS:
        ...
        try:
            # Instead of hammering OpenSky which kills the 400/day unauthenticated limit,
            # we simulate global scanning unless we have a massive enterprise API quota.
            await asyncio.sleep(random.uniform(0.5, 2.0))
            
            # Simulate a 1 in 50 chance of finding an extreme risk during the scan
